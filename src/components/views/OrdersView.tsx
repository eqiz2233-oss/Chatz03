                ...
                {items.map((o) => {
                  ...
                  return (
                    <div
                      key={o.id}
                      className={
                        'group flex min-h-[9.5rem] shrink-0 rounded-lg border border-slate-200 p-2.5 transition hover:border-brand-300 hover:shadow-sm dark:border-slate-700 dark:hover:border-brand-500 ' +
                        (hasSlipImg ? 'flex w-[236px] flex-row gap-2' : 'flex w-[220px] flex-col')
                      }
                    >
                      {hasSlipImg && (
                        <button
                          ...
                          aria-label={t('orders.slipImageAria')}
                          className="relative h-auto min-h-[5.25rem] w-14 shrink-0 overflow-hidden rounded-md border border-slate-200 bg-slate-100 ring-brand-400/0 transition hover:ring-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 dark:border-slate-600 dark:bg-slate-800 dark:hover:ring-brand-400"
                        >
                          ...
                          <span className="pointer-events-none absolute bottom-0.5 left-0.5 right-0.5 rounded bg-black/55 py-0.5 text-[9px] font-medium text-white opacity-0 transition group-hover:opacity-100">
                      ...
                      <div className="flex min-w-0 flex-1 flex-col">
                        ...
                        <div className="mt-2 flex items-end justify-between gap-1">
                          ...
                          {o.slipStatus === 'verified' && (
                            <span className="chip shrink-0 bg-emerald-100 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-300">
