// Lightweight inline SVG icons (Lucide-inspired) — no dependency
...
export const I = {
  ...
  Receipt: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base} {...p}><path d="M4 2v20l3-2 3 2 3-2 3 2 3-2 3 2V2l-3 2-3-2-3 2-3-2-3 2Z"/><path d="M16 8H8"/><path d="M16 12H8"/><path d="M13 16H8"/></svg>
  ),
  ...
  Bot: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base} {...p}><rect x="3" y="11" width="18" height="10" rx="2"/><circle cx="12" cy="5" r="2"/><path d="M12 7v4"/><line x1="8" y1="16" x2="8" y2="16"/><line x1="16" y1="16" x2="16" y2="16"/></svg>
  ),
  ...
  Image: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base} {...p}><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
  ),
  ...
  Truck: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base} {...p}><rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>
  ),
  ...
  Plug: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base} {...p}><path d="M9 2v6"/><path d="M15 2v6"/><path d="M6 8h12v4a6 6 0 0 1-12 0V8z"/><path d="M12 18v4"/></svg>
  ),
  Sparkles: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base} {...p}><path d="M12 3l1.8 4.6L18 9l-4.2 1.4L12 15l-1.8-4.6L6 9l4.2-1.4L12 3z"/><path d="M19 14l.9 2.3L22 17l-2.1.7L19 20l-.9-2.3L16 17l2.1-.7L19 14z"/></svg>
  ),
  Store: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base} {...p}><path d="M3 9h18v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9Z"/><path d="m3 9 2.45-4.9A2 2 0 0 1 7.24 3h9.52a2 2 0 0 1 1.8 1.1L21 9"/><path d="M12 3v6"/><path d="M9 9v12"/><path d="M15 9v12"/></svg>
  ),
  MoreVertical: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base} {...p}><circle cx="12" cy="5" r="1" fill="currentColor" stroke="none" /><circle cx="12" cy="12" r="1" fill="currentColor" stroke="none" /><circle cx="12" cy="19" r="1" fill="currentColor" stroke="none" /></svg>
  ),
  ...
  VideoCam: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base} {...p}>
  ...
  Maximize2: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base} {...p}>
  ...
  Trash2: (p: SVGProps<SVGSVGElement>) => (
    <svg {...base} {...p}>
...
export function ChannelIcon({ channel, className = 'h-4 w-4' }: { channel: 'line' | 'ig' | 'facebook'; className?: string }) {
  if (channel === 'line') {
    return (
      <svg className={className} viewBox="0 0 24 24" fill="#06C755" xmlns="http://www.w3.org/2000/svg">
